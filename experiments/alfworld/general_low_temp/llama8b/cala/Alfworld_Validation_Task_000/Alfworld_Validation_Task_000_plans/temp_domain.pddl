(define (domain alfred)
    ...
    (:predicates
        ...
        (examined ?o - object ?l - object) ; true if object was examined with light source the object has been looked at with light
    ...
    ;; Examine an object (being held) using light source atbyrdgb location
